...
export function OutputCards({
	...
	/*
		TDODO: below useEffect hook makes the app re-render like crazy, hugely affecting the performance
		should find the better way to do this
	*/
...
function OutputCardContent({
	...
	} else if (outputCard?.type === 'FIND_CANDIDATES') {
		return <LinkedInCandidateProfilesCard {...outputCard} outputCardAction={outputCardAction} handleCardClose={handleCardClose}/>;
