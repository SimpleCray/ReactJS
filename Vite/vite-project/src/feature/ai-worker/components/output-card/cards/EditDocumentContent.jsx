	...
	return (
		...
		>
			{isError ? (
				...
				<TextEditorCommon key={keyTextEditor} htmlContent={content} onSave={onHandleSave} defaultIsEditMode={editContent} setDefaultIsEditMode={setEditContent} isLoading={isPendingEdit} isRequired={false}/>
			)}
			<Box mt={2}>
